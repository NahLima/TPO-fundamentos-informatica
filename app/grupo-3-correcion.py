...
tarifas = [['RESIDENCIAL', 750, 6.5, 15], ['COMERCIO', 1500, 7.5, 15], [
    'PYME', 3000, 8, 25], ['INDUSTRIA', 7500, 10, 30], ['ESTATAL', 3500, 3.5, 10]]
...
def generar_datos_clientes():
    ...
    for item in range(total_clientes):
        ...
        tipo_cliente = tipo_de_cliente[random.randint(
            0, len(tipo_de_cliente) - 1)]
...
def programa_principal():
    ...
    while opcion != '5':
        ...
        if opcion == '1':
            ...
            tipo_elegido = input(
                "Elija un tipo de cliente (RESIDENCIAL/COMERCIO/PYME/INDUSTRIA/ESTATAL): ")
