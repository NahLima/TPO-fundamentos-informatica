...
'''Esta función la usamos para calcular la facturación total y la cantidad de clientes para cada tipo de cliente
y se utilizara una lista vacia que se utilizará para almacenar la información'''
'''si el cliente es el mismo, que se vayan sumando las facturaciones'''
...
'''luego le pedimos que nos devuelva el listado de clientes'''
...
#bubble sort
'''usamos un bubble sort, la función realiza una ordenación descendente de la lista de datos para que de esta forma queden ordenados'''
...
def programa_principal():
    ...
    opcion = None
# aca arrancamos pidiendo que nos pida una opcion, si la opcion no esta dentro de 1-5 le pediremos que la pida otra vez
    while opcion != 5:
        print("\nMenú Principal:")
        ...
        while opcion < 1 or opcion > 5:
            print("Opción no válida. Por favor, ingrese 1, 2, 3, 4 para tener informaciones o 5 para salir.")
            opcion = int(input("Elija una opción (1/2/3/4/5): "))
            
#si la opcion es 1, le pediremos que muestre los clientes y su facturacion por mes
        if opcion == 1:
            print("------------------------------------------------------------------------")
            print("Total de Facturación del Mes:", total_facturacion_mes)
            print("Cantidad de Clientes:", len(datos_clientes))
 
#si la opcion es 2, nos mostrara el total de facturacion y la cant. de clientes de cada cliente(pyme, comercio,etc...)
        elif opcion == 2:
...
#si la opcion es 3, nos dara el tipo de cliente y su consumo de KW/Hora y la cantidad de su facturacion               
        elif opcion == 3:
...
#si la opcion es 4, nos pedira ingresar un tipo de cliente, en caso contrario, debera volver a ingresar la opcion y el cliente correctamente
#luego, ingresando el tipo de cliente, nos dira la cant. de clientes y el total de su facturacion
        elif opcion == 4:
